...
export const series: Series[] = [
  ...
  },
  {
    ...
    blurb:
      "Hackers, social engineering, supply chain attacks, password cracking. The threat landscape, demystified.",
    count: 7,
    paid: 7,
    free: 0,
    pricePer: 5,
  ...
  },
  {
    ...
    blurb:
      "Rule-based, trees, neural nets, CNNs, transformers, RL. The model zoo without the math PhD.",
    count: 6,
    paid: 6,
    free: 0,
    pricePer: 5,
  ...
  },
  {
    ...
    title: "Securing AI",
    blurb:
      "Prompt injection, jailbreaking, data poisoning, RAG attacks, agent attacks. Plus a practical defense playbook.",
    count: 9,
    paid: 8,
    free: 1,
    pricePer: 15,
  ...
  },
  {
    ...
    title: "Securing APIs",
    blurb:
      "Broken object authorization, auth/authn, rate limiting, misconfig, sensitive data exposure. Plus a defense guide.",
    count: 7,
    paid: 6,
    free: 1,
    pricePer: 15,
    ...
    category: "securing",
    featured: false,
    tag: "For backend teams",
  },
  {
    id: "securing-cloud",
    title: "Securing the Cloud",
    blurb:
      "Attacking and defending AWS, Azure, and GCP. Common cloud attack vectors and the practical fixes for each.",
    count: 7,
    paid: 6,
    free: 1,
    pricePer: 15,
